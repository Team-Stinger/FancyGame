...
*
* v2.4.1 "Ionin Spring" - Built: Fri Jul 24 2015 13:26:30
*
...
/**
    ...
    * @license      {@link https://github.com/photonstorm/phaser/blob/master/license.txt|MIT License}
    */
n.Component.Destroy=function(){};n.Component.Destroy.prototype={destroyPhase:!1,destroy:function(t){if(this.game!==null&&!this.destroyPhase){if(t===undefined&&(t=!0),this.destroyPhase=!0,this.events)this.events.onDestroy$dispatch(this);this.parent&&(this.parent instanceof n.Group?this.parent.remove(this):this.parent.removeChild(this));this.input&&this.input.destroy();this.animations&&this.animations.destroy();this.body&&this.body.destroy();this.events&&this.events.destroy();var i=this.children.length;if(t)while(i--)this.children[i].destroy(t);else while(i--)this.removeChild(this.children[i]);this._crop&&(this._crop=null);this._frame&&(this._frame=null);n.Video&&this.key instanceof n.Video&&this.key.onChangeSource.remove(this.resizeFrame,this);n.BitmapText&&this._glyphs&&(this._glyphs=[]);this.alive=!1;this.exists=!1;this.visible=!1;this.filters=null;this.mask=null;this.game=null;this.renderable=!1;this.transformCallback=null;this.transformCallbackContext=null;this.hitArea=null;this.parent=null;this.stage=null;this.worldTransform=null;this.filterArea=null;this._bounds=null;this._currentBounds=null;this._mask=null;this._destroyCachedSprite();this.destroyPhase=!1;this.pendingDestroy=!1}}};
/**
    * @author       Richard Davey <rich@photonstorm.com>
    * @copyright    2015 Photon Storm Ltd.
    * @license      {@link https://github.com/photonstorm/phaser/blob/master/license.txt|MIT License}
...
/**
    ...
    * @license      {@link https://github.com/photonstorm/phaser/blob/master/license.txt|MIT License}
    */
n.Component.Health=function(){};n.Component.Health.prototype={health:1,maxHealth:100,damage:function(n){return this.alive&&(this.health-=n,this.health<=0&&this.kill()),this},heal:function(n){return this.alive&&(this.health+=n,this.health>this.maxHealth&&(this.health=this.maxHealth)),this}};
/**
    * @author       Richard Davey <rich@photonstorm.com>
    * @copyright    2015 Photon Storm Ltd.
    * @license      {@link https://github.com/photonstorm/phaser/blob/master/license.txt|MIT License}
...
/**
    ...
    * @license      {@link https://github.com/photonstorm/phaser/blob/master/license.txt|MIT License}
    */
n.Component.ScaleMinMax=function(){};n.Component.ScaleMinMax.prototype={transformCallback:this.checkTransform,transformCallbackContext:this,scaleMin:null,scaleMax:null,checkTransform:function(n){this.scaleMin&&(n.a<this.scaleMin.x&&(n.a=this.scaleMin.x),n.d<this.scaleMin.y&&(n.d=this.scaleMin.y));this.scaleMax&&(n.a>this.scaleMax.x&&(n.a=this.scaleMax.x),n.d>this.scaleMax.y&&(n.d=this.scaleMax.y))},setScaleMinMax:function(t,i,r,u){i===undefined?i=r=u=t:r===undefined&&(r=u=i,i=t);t===null?this.scaleMin=null:this.scaleMin?this.scaleMin.set(t,i):this.scaleMin=new n.Point(t,i);r===null?this.scaleMax=null:this.scaleMax?this.scaleMax.set(r,u):this.scaleMax=new n.Point(r,u)}};
/**
    * @author       Richard Davey <rich@photonstorm.com>
    * @copyright    2015 Photon Storm Ltd.
    * @license      {@link https://github.com/photonstorm/phaser/blob/master/license.txt|MIT License}
